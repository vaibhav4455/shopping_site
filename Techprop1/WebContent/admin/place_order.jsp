<%-- 
    Document   : signup
    Created on : Mar 10, 2018, 12:39:36 PM
    Author     : user
--%>
    ...
    try{
        ...
        <div align="center">
                <table border="0" style=" width: 840px; height: 50px">
                    <tr>
                        ...
                        <td height="40"><h2>Contact us: +917876993331 || krishkrishan786@gmail.com</h2></td>
                    </tr>
                    <tr>
                        <td><p style=" font-size: 12px">Ktech Services Pvt. Ltd. Warehouse Address: Azad nagar, Kaithal - 136027</p></td>
                    </tr>
                </table>
      ...
      %>
        ...
        <table style=" width: 840px" border="0">
                    ...
                    <tr>
                        <td>
                            Ktech Services Pvt. Ltd. Regd Office: Azad nagar, Kaithal - 136027
                        </td>
                    </tr>
                    <tr>
                        <td>
