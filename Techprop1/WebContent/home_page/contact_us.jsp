<%-- 
    Document   : index
    Created on : Mar 9, 2018, 5:56:49 PM
...
<div class="shell">
  ...
  <table width="57" border="0" style="float: left">
      ...
      <table width="380" border="0" style="float: left;">
          ...
          <tr>
              <td height="30"></td>
              <td height="30" style="color: blue; font-size: 16px">Pick up the phone and call us @7876993331</td>
          </tr>
          <tr>
              <td height="30"></td>
    ...
    <table width="57" border="0" style="float: left">
      ...
      <table width="280" border="0">
          ...
          <tr>
              <td height="25"></td>
              <td style="color: blue; font-size: 16px">Techprop Internet Private Limited,</td>
          </tr>
          <tr>
              <td height="25"></td>
              <td style="color: blue; font-size: 16px">KtEch Chandana Gate</td>
          </tr>
          <tr>
              <td height="25"></td>
              <td style="color: blue; font-size: 16px">Kaithal</td>
          </tr>
          <tr>
              <td height="25"></td>
              <td style="color: blue; font-size: 16px">Haryana</td>
          </tr>
      </table>
